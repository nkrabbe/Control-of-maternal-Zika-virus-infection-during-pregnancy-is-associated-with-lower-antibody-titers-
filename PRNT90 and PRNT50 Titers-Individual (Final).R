...
##Pre-infection
PRNT_individual_preinfection <- filter(PRNT_individual, Timepoint_MPI == 'Pre-Infection')
#PRNT90
...
dev.off()
## 1 MPI
PRNT_individual_1mpi <- filter(PRNT_individual, Timepoint_MPI == '1')
#PRNT90
PRNT_individual_1mpi_PRNT90 <- filter(PRNT_individual_1mpi, PRNT == '90')
PRNT_individual_1mpi_PRNT90_figure <-
  ggplot() +
  geom_bar(data= PRNT_individual_1mpi_PRNT90, aes(x= Animal_ID, y= Estimated_Reciprocal_Serum_Dilution, color = Animal_ID, fill= Animal_ID), stat= 'identity', width= 0.25) +
  theme_classic() + 
  scale_x_discrete(name = 'Dam ID') + 
  scale_y_log10(name = 'ZIKV PRNT90', limits = c(1e0, 1e5), breaks = c(10, 20, 80, 320, 1280, 5120, 20480), expand = c(0,0)) + 
  geom_hline(yintercept = 10, linetype = 'dotted') + 
  ...
  theme(axis.text.x = element_text(size = 14, angle = 90, hjust = 1, vjust= 0.5), axis.text.y = element_text(size = 14), axis.title = element_text(size = 18, face = 'bold'), aspect.ratio = 1)
PRNT_individual_1mpi_PRNT90_figure  
tiff('1 MPI PRNT90 (Final).tiff', units= 'in', height= 5, width= 5, res= 300)
PRNT_individual_1mpi_PRNT90_figure
dev.off()
#PRNT50
PRNT_individual_1mpi_PRNT50 <- filter(PRNT_individual_1mpi, PRNT == '50')
PRNT_individual_1mpi_PRNT50_figure <-
  ggplot() +
  geom_bar(data= PRNT_individual_1mpi_PRNT50, aes(x= Animal_ID, y= Estimated_Reciprocal_Serum_Dilution, color = Animal_ID, fill= Animal_ID), stat= 'identity', width= 0.25) +
  theme_classic() + 
  scale_x_discrete(name = 'Dam ID') + 
  scale_y_log10(name = 'ZIKV PRNT50', limits = c(1e0, 1e5), breaks = c(10, 20, 80, 320, 1280, 5120, 20480), expand = c(0,0)) + 
  geom_vline(xintercept = 9.5, linetype = 'solid') +
  ...
  theme(axis.text.x = element_text(size = 14, angle = 90, hjust = 1, vjust= 0.5), axis.text.y = element_text(size = 14), axis.title = element_text(size = 18, face = 'bold'), aspect.ratio = 1)
PRNT_individual_1mpi_PRNT50_figure  
tiff('1 MPI PRNT50 (Final).tiff', units= 'in', width= 5, height= 5, res= 300)
PRNT_individual_1mpi_PRNT50_figure
dev.off()
## 3-4 MPI
PRNT_individual_3.4mpi <- filter(PRNT_individual, Timepoint_MPI == '3-4')
#PRNT90
PRNT_individual_3.4mpi_PRNT90 <- filter(PRNT_individual_3.4mpi, PRNT == '90')
PRNT_individual_3.4mpi_PRNT90_figure <-
  ggplot() +
  geom_bar(data= PRNT_individual_3.4mpi_PRNT90, aes(x= Animal_ID, y= Estimated_Reciprocal_Serum_Dilution, color = Animal_ID, fill= Animal_ID), stat= 'identity', width= 0.25) +
  theme_classic() + 
  scale_x_discrete(name = 'Dam ID') + 
  scale_y_log10(name = 'ZIKV PRNT90', limits = c(1e0, 1e5), breaks = c(10, 20, 80, 320, 1280, 5120, 20480), expand = c(0,0)) + 
  geom_hline(yintercept = 10, linetype = 'dotted') + 
  ...
  theme(axis.text.x = element_text(size = 14, angle = 90, hjust = 1, vjust= 0.5), axis.text.y = element_text(size = 14), axis.title = element_text(size = 18, face = 'bold'), aspect.ratio = 1)
PRNT_individual_3.4mpi_PRNT90_figure  
tiff('3-4 MPI PRNT90 (Final).tiff', units= 'in', width= 5, height= 5, res= 300)
PRNT_individual_3.4mpi_PRNT90_figure
dev.off()
#PRNT50
PRNT_individual_3.4mpi_PRNT50 <- filter(PRNT_individual_3.4mpi, PRNT == '50')
PRNT_individual_3.4mpi_PRNT50_figure <-
  ggplot() +
  geom_bar(data= PRNT_individual_3.4mpi_PRNT50, aes(x= Animal_ID, y= Estimated_Reciprocal_Serum_Dilution, color = Animal_ID, fill= Animal_ID), stat= 'identity', width= 0.25) +
  theme_classic() + 
  scale_x_discrete(name = 'Dam ID') + 
  scale_y_log10(name = 'ZIKV PRNT50', limits = c(1e0, 1e5), breaks = c(10, 20, 80, 320, 1280, 5120, 20480), expand = c(0,0)) + 
  geom_vline(xintercept = 9.5, linetype = 'solid') +
  ...
  theme(axis.text.x = element_text(size = 14, angle = 90, hjust = 1, vjust= 0.5), axis.text.y = element_text(size = 14), axis.title = element_text(size = 18, face = 'bold'), aspect.ratio = 1)
PRNT_individual_3.4mpi_PRNT50_figure  
tiff('3-4 MPI PRNT50 (Final).tiff', units= 'in', height= 5, width = 5, res= 300)
PRNT_individual_3.4mpi_PRNT50_figure
dev.off()
