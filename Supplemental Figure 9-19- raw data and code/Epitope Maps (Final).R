...
ggarrange(IgM_epitope_maps_2wpi_capsid_figure_wrapped, IgM_epitope_maps_3wpi_capsid_figure_wrapped, IgG_epitope_maps_1mpi_capsid_figure_wrapped, IgG_epitope_maps_3.4mpi_capsid_figure_wrapped, ncol=4, nrow=1, labels= c('A', 'B', 'C', 'D'), align = 'hv', common.legend= TRUE)
dev.off()
#PrM
tiff('PrM Epitope Map (Final).tiff', units= 'in', width= 20, height= 10, res= 300)
ggarrange(IgM_epitope_maps_2wpi_PrM_figure_wrapped, IgM_epitope_maps_3wpi_PrM_figure_wrapped, IgG_epitope_maps_1mpi_PrM_figure_wrapped, IgG_epitope_maps_3.4mpi_PrM_figure_wrapped, ncol=4, nrow=1, labels= c('A', 'B', 'C', 'D'), align = 'hv', common.legend = TRUE)
dev.off()
#mem
tiff('Membrane Epitope Map (Final).tiff', units= 'in', width= 20, height= 10, res= 300)
ggarrange(IgM_epitope_maps_2wpi_mem_figure_wrapped, IgM_epitope_maps_3wpi_mem_figure_wrapped, IgG_epitope_maps_1mpi_mem_figure_wrapped, IgG_epitope_maps_3.4mpi_mem_figure_wrapped, ncol=4, nrow=1, labels= c('A', 'B', 'C', 'D'), align = 'hv', common.legend = TRUE)
dev.off()
#envelope
tiff('Envelope Epitope Map (Final).tiff', units= 'in', width= 20, height= 10, res= 300)
ggarrange(IgM_epitope_maps_2wpi_env_figure_wrapped, IgM_epitope_maps_3wpi_env_figure_wrapped, IgG_epitope_maps_1mpi_env_figure_wrapped, IgG_epitope_maps_3.4mpi_env_figure_wrapped, ncol=4, nrow=1, labels= c('A', 'B', 'C', 'D'), align = 'hv', common.legend= TRUE)
dev.off()
#NS1
tiff('NS1 Epitope Map (Final).tiff', units= 'in', width= 20, height= 10, res= 300)
ggarrange(IgM_epitope_maps_2wpi_NS1_figure_wrapped, IgM_epitope_maps_3wpi_NS1_figure_wrapped, IgG_epitope_maps_1mpi_NS1_figure_wrapped, IgG_epitope_maps_3.4mpi_NS1_figure_wrapped, ncol=4, nrow=1, labels= c('A', 'B', 'C', 'D'), align = 'hv', common.legend= TRUE)
dev.off()
#NS2A
tiff('NS2A Epitope Map (Final).tiff', units= 'in', width= 20, height= 10, res= 300)
ggarrange(IgM_epitope_maps_2wpi_NS2A_figure_wrapped, IgM_epitope_maps_3wpi_NS2A_figure_wrapped, IgG_epitope_maps_1mpi_NS2A_figure_wrapped, IgG_epitope_maps_3.4mpi_NS2A_figure_wrapped, ncol=4, nrow=1, labels= c('A', 'B', 'C', 'D'), align = 'hv', common.legend= TRUE)
dev.off()
#NS2B
tiff('NS2B Epitope Map (Final).tiff', units= 'in', width= 20, height= 10, res= 300)
ggarrange(IgM_epitope_maps_2wpi_NS2B_figure_wrapped, IgM_epitope_maps_3wpi_NS2B_figure_wrapped, IgG_epitope_maps_1mpi_NS2B_figure_wrapped, IgG_epitope_maps_3.4mpi_NS2B_figure_wrapped, ncol=4, nrow=1, labels= c('A', 'B', 'C', 'D'), align = 'hv', common.legend= TRUE)
dev.off()
#NS3
tiff('NS3 Epitope Map (Final).tiff', units= 'in', width= 20, height= 10, res= 300)
ggarrange(IgM_epitope_maps_2wpi_NS3_figure_wrapped, IgM_epitope_maps_3wpi_NS3_figure_wrapped, IgG_epitope_maps_1mpi_NS3_figure_wrapped, IgG_epitope_maps_3.4mpi_NS3_figure_wrapped, ncol=4, nrow=1, labels= c('A', 'B', 'C', 'D'), align = 'hv', common.legend = TRUE)
dev.off()
#NS4A
tiff('NS4A Epitope Map (Final).tiff', units= 'in', width= 20, height= 10, res= 300)
ggarrange(IgM_epitope_maps_2wpi_NS4A_figure_wrapped, IgM_epitope_maps_3wpi_NS4A_figure_wrapped, IgG_epitope_maps_1mpi_NS4A_figure_wrapped, IgG_epitope_maps_3.4mpi_NS4A_figure_wrapped, ncol=4, nrow=1, labels= c('A', 'B', 'C', 'D'), align = 'hv', common.legend= TRUE)
dev.off()
#NS4B
tiff('NS4B Epitope Map (Final).tiff', units= 'in', width= 20, height= 10, res= 300)
ggarrange(IgM_epitope_maps_2wpi_NS4B_figure_wrapped, IgM_epitope_maps_3wpi_NS4B_figure_wrapped, IgG_epitope_maps_1mpi_NS4B_figure_wrapped, IgG_epitope_maps_3.4mpi_NS4B_figure_wrapped, ncol=4, nrow=1, labels= c('A', 'B', 'C', 'D'), align = 'hv', common.legend = TRUE)
dev.off()
#NS5
tiff('NS5 Epitope Map (Final).tiff', units= 'in', width= 20, height= 10, res= 300)
ggarrange(IgM_epitope_maps_2wpi_NS5_figure_wrapped, IgM_epitope_maps_3wpi_NS5_figure_wrapped, IgG_epitope_maps_1mpi_NS5_figure_wrapped, IgG_epitope_maps_3.4mpi_NS5_figure_wrapped, ncol=4, nrow=1, labels= c('A', 'B', 'C', 'D'), align = 'hv', common.legend = TRUE)
dev.off()
