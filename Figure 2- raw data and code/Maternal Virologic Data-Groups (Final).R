...
ggarrange(plasma_vRNA_burden_duration_group_figure, plasma_infectious_virus_duration_group_figure, peak_plasma_vRNA_group_figure, vRNA_infectivity_ratio_group_figure, AUC_group_figure, mfi_vRNA_burden_group_figure, labels= c('A', 'B', 'C', 'D', 'E', 'F'), nrow= 2, ncol = 3, align= 'v', common.legend = TRUE, legend = 'top')
dev.off()
