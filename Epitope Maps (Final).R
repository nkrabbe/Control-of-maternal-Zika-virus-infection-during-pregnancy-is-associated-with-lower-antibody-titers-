...
IgM_epitope_maps_2wpi$Amino_Acid_Position = as.numeric(IgM_epitope_maps_2wpi$Amino_Acid_Position)
...
IgM_epitope_maps_2wpi_capsid_figure <-
  ggplot() +
  geom_bar(data= IgM_epitope_maps_2wpi_capsid, aes(x= Amino_Acid_Position, y= Percent_Positive_Animals, color= Virologic_Control_Group, fill= Virologic_Control_Group), stat= 'identity') +
  theme_classic() +
...
IgM_epitope_maps_2wpi_PrM_figure <-
  ggplot() +
  geom_bar(data= IgM_epitope_maps_2wpi_PrM, aes(x= Amino_Acid_Position, y= Percent_Positive_Animals, color= Virologic_Control_Group, fill= Virologic_Control_Group), stat= 'identity') +
  theme_classic() +
...
IgM_epitope_maps_2wpi_mem_figure <-
  ggplot() +
  geom_bar(data= IgM_epitope_maps_2wpi_mem, aes(x= Amino_Acid_Position, y= Percent_Positive_Animals, color= Virologic_Control_Group, fill= Virologic_Control_Group), stat= 'identity') +
  theme_classic() +
...
IgM_epitope_maps_2wpi_env_figure <-
  ggplot() +
  geom_bar(data= IgM_epitope_maps_2wpi_env, aes(x= Amino_Acid_Position, y= Percent_Positive_Animals, color= Virologic_Control_Group, fill= Virologic_Control_Group), stat= 'identity') +
  theme_classic() +
...
IgM_epitope_maps_2wpi_NS1_figure <-
  ggplot() +
  geom_bar(data= IgM_epitope_maps_2wpi_NS1, aes(x= Amino_Acid_Position, y= Percent_Positive_Animals, color= Virologic_Control_Group, fill= Virologic_Control_Group), stat= 'identity') +
  theme_classic() +
...
IgM_epitope_maps_2wpi_NS2A_figure <-
  ggplot() +
  geom_bar(data= IgM_epitope_maps_2wpi_NS2A, aes(x= Amino_Acid_Position, y= Percent_Positive_Animals, color= Virologic_Control_Group, fill= Virologic_Control_Group), stat= 'identity') +
  theme_classic() +
...
IgM_epitope_maps_2wpi_NS2B_figure <-
  ggplot() +
  geom_bar(data= IgM_epitope_maps_2wpi_NS2B, aes(x= Amino_Acid_Position, y= Percent_Positive_Animals, color= Virologic_Control_Group, fill= Virologic_Control_Group), stat= 'identity') +
  theme_classic() +
...
IgM_epitope_maps_2wpi_NS3_figure <-
  ggplot() +
  geom_bar(data= IgM_epitope_maps_2wpi_NS3, aes(x= Amino_Acid_Position, y= Percent_Positive_Animals, color= Virologic_Control_Group, fill= Virologic_Control_Group), stat= 'identity') +
  theme_classic() +
...
IgM_epitope_maps_2wpi_NS4A_figure <-
  ggplot() +
  geom_bar(data= IgM_epitope_maps_2wpi_NS4A, aes(x= Amino_Acid_Position, y= Percent_Positive_Animals, color= Virologic_Control_Group, fill= Virologic_Control_Group), stat= 'identity') +
  theme_classic() +
...
IgM_epitope_maps_2wpi_NS4B_figure <-
  ggplot() +
  geom_bar(data= IgM_epitope_maps_2wpi_NS4B, aes(x= Amino_Acid_Position, y= Percent_Positive_Animals, color= Virologic_Control_Group, fill= Virologic_Control_Group), stat= 'identity') +
  theme_classic() +
...
IgM_epitope_maps_2wpi_NS5_figure <-
  ggplot() +
  geom_bar(data= IgM_epitope_maps_2wpi_NS5, aes(x= Amino_Acid_Position, y= Percent_Positive_Animals, color= Virologic_Control_Group, fill= Virologic_Control_Group), stat= 'identity') +
  theme_classic() +
...
IgM_epitope_maps_3wpi$Amino_Acid_Position = as.numeric(IgM_epitope_maps_3wpi$Amino_Acid_Position)
...
IgM_epitope_maps_3wpi_capsid_figure <-
  ggplot() +
  geom_bar(data= IgM_epitope_maps_3wpi_capsid, aes(x= Amino_Acid_Position, y= Percent_Positive_Animals, color= Virologic_Control_Group, fill= Virologic_Control_Group), stat= 'identity') +
  theme_classic() +
  scale_x_continuous(name= 'Amino Acid Position', expand= c(0,0), limits= c(0, 125), breaks= c(0, 30, 60, 90, 120)) +
  scale_y_continuous(name= "Positive Dams (%)", expand= c(0,0), limits= c(0,100), breaks= c(0, 25, 50, 75, 100)) +
...
IgM_epitope_maps_3wpi_PrM_figure <-
  ggplot() +
  geom_bar(data= IgM_epitope_maps_3wpi_PrM, aes(x= Amino_Acid_Position, y= Percent_Positive_Animals, color= Virologic_Control_Group, fill= Virologic_Control_Group), stat= 'identity') +
  theme_classic() +
  scale_x_continuous(name= 'Amino Acid Position', expand= c(0,0), limits= c(120, 220), breaks= c(130, 150, 170, 190, 210)) +
  scale_y_continuous(name= "Positive Dams (%)", expand= c(0,0), limits= c(0,100), breaks= c(0, 25, 50, 75, 100)) +
  labs(title= '3 WPI (IgM)') +
...
IgM_epitope_maps_3wpi_mem_figure <-
  ggplot() +
  geom_bar(data= IgM_epitope_maps_3wpi_mem, aes(x= Amino_Acid_Position, y= Percent_Positive_Animals, color= Virologic_Control_Group, fill= Virologic_Control_Group), stat= 'identity') +
  theme_classic() +
  scale_x_continuous(name= 'Amino Acid Position', expand= c(0,0), limits= c(210, 300), breaks= c(220, 240, 260, 280, 300)) +
  scale_y_continuous(name= "Positive Dams (%)", expand= c(0,0), limits= c(0,100), breaks= c(0, 25, 50, 75, 100)) +
  labs(title= '3 WPI (IgM)') +
...
IgM_epitope_maps_3wpi_env_figure <-
  ggplot() +
  geom_bar(data= IgM_epitope_maps_3wpi_env, aes(x= Amino_Acid_Position, y= Percent_Positive_Animals, color= Virologic_Control_Group, fill= Virologic_Control_Group), stat= 'identity') +
  theme_classic() +
  scale_x_continuous(name= 'Amino Acid Position', expand= c(0,0), limits= c(280, 805), breaks= c(300, 400, 500, 600, 700, 800)) +
  scale_y_continuous(name= "Positive Dams (%)", expand= c(0,0), limits= c(0,100), breaks= c(0, 25, 50, 75, 100)) +
  labs(title= '3 WPI (IgM)') +
...
IgM_epitope_maps_3wpi_NS1_figure <-
  ggplot() +
  geom_bar(data= IgM_epitope_maps_3wpi_NS1, aes(x= Amino_Acid_Position, y= Percent_Positive_Animals, color= Virologic_Control_Group, fill= Virologic_Control_Group), stat= 'identity') +
  theme_classic() +
  scale_x_continuous(name= 'Amino Acid Position', expand= c(0,0), limits= c(785, 1165), breaks= c(800, 900, 1000, 1100)) +
  scale_y_continuous(name= "Positive Dams (%)", expand= c(0,0), limits= c(0,100), breaks= c(0, 25, 50, 75, 100)) +
  labs(title= '3 WPI (IgM)') +
...
IgM_epitope_maps_3wpi_NS2A_figure <-
  ggplot() +
  geom_bar(data= IgM_epitope_maps_3wpi_NS2A, aes(x= Amino_Acid_Position, y= Percent_Positive_Animals, color= Virologic_Control_Group, fill= Virologic_Control_Group), stat= 'identity') +
  theme_classic() +
  scale_x_continuous(name= 'Amino Acid Position', expand= c(0,0), limits= c(1150, 1385), breaks= c(1200, 1250, 1300, 1350)) +
  scale_y_continuous(name= "Positive Dams (%)", expand= c(0,0), limits= c(0,100), breaks= c(0, 25, 50, 75, 100)) +
  labs(title= '3 WPI (IgM)') +
...
IgM_epitope_maps_3wpi_NS2B_figure <-
  ggplot() +
  geom_bar(data= IgM_epitope_maps_3wpi_NS2B, aes(x= Amino_Acid_Position, y= Percent_Positive_Animals, color= Virologic_Control_Group, fill= Virologic_Control_Group), stat= 'identity') +
  theme_classic() +
  scale_x_continuous(name= 'Amino Acid Position', expand= c(0,0), limits= c(1370, 1530), breaks= c(1380, 1420, 1460, 1500)) +
  scale_y_continuous(name= "Positive Dams (%)", expand= c(0,0), limits= c(0,100), breaks= c(0, 25, 50, 75, 100)) +
  labs(title= '3 WPI (IgM)') +
...
IgM_epitope_maps_3wpi_NS3_figure <-
  ggplot() +
  geom_bar(data= IgM_epitope_maps_3wpi_NS3, aes(x= Amino_Acid_Position, y= Percent_Positive_Animals, color= Virologic_Control_Group, fill= Virologic_Control_Group), stat= 'identity') +
  theme_classic() +
  scale_x_continuous(name= 'Amino Acid Position', expand= c(0,0), limits= c(1500, 2150), breaks= c(1600, 1700, 1800, 1900, 2000, 2100)) +
  scale_y_continuous(name= "Positive Dams (%)", expand= c(0,0), limits= c(0,100), breaks= c(0, 25, 50, 75, 100)) +
  labs(title= '3 WPI (IgM)') +
...
IgM_epitope_maps_3wpi_NS4A_figure <-
  ggplot() +
  geom_bar(data= IgM_epitope_maps_3wpi_NS4A, aes(x= Amino_Acid_Position, y= Percent_Positive_Animals, color= Virologic_Control_Group, fill= Virologic_Control_Group), stat= 'identity') +
  theme_classic() +
  scale_x_continuous(name= 'Amino Acid Position', expand= c(0,0), limits= c(2115, 2280), breaks= c(2125, 2175, 2225, 2275)) +
  scale_y_continuous(name= "Positive Dams (%)", expand= c(0,0), limits= c(0,100), breaks= c(0, 25, 50, 75, 100)) +
  labs(title= '3 WPI (IgM)') +
...
IgM_epitope_maps_3wpi_NS4B_figure <-
  ggplot() +
  geom_bar(data= IgM_epitope_maps_3wpi_NS4B, aes(x= Amino_Acid_Position, y= Percent_Positive_Animals, color= Virologic_Control_Group, fill= Virologic_Control_Group), stat= 'identity') +
  theme_classic() +
  scale_x_continuous(name= 'Amino Acid Position', expand= c(0,0), limits= c(2265, 2550), breaks= c(2300, 2350, 2400, 2450, 2500)) +
  scale_y_continuous(name= "Positive Dams (%)", expand= c(0,0), limits= c(0,100), breaks= c(0, 25, 50, 75, 100)) +
  labs(title= '3 WPI (IgM)') +
...
IgM_epitope_maps_3wpi_NS5_figure <-
  ggplot() +
  geom_bar(data= IgM_epitope_maps_3wpi_NS5, aes(x= Amino_Acid_Position, y= Percent_Positive_Animals, color= Virologic_Control_Group, fill= Virologic_Control_Group), stat= 'identity') +
  theme_classic() +
  scale_x_continuous(name= 'Amino Acid Position', expand= c(0,0), limits= c(2515, 3415), breaks= c(2520, 2720, 2920, 3120, 3320)) +
  scale_y_continuous(name= "Positive Dams (%)", expand= c(0,0), limits= c(0,100), breaks= c(0, 25, 50, 75, 100)) +
  labs(title= '3 WPI (IgM)') +
...
IgG_epitope_maps_1mpi$Amino_Acid_Position = as.numeric(IgG_epitope_maps_1mpi$Amino_Acid_Position)
...
IgG_epitope_maps_1mpi_capsid_figure <-
  ggplot() +
  geom_bar(data= IgG_epitope_maps_1mpi_capsid, aes(x= Amino_Acid_Position, y= Percent_Positive_Animals, color= Virologic_Control_Group, fill= Virologic_Control_Group), stat= 'identity') +
  theme_classic() +
  scale_x_continuous(name= 'Amino Acid Position', expand= c(0,0), limits= c(0, 125), breaks= c(0, 30, 60, 90, 120)) +
  scale_y_continuous(name= "Positive Dams (%)", expand= c(0,0), limits= c(0,100), breaks= c(0, 25, 50, 75, 100)) +
...
IgG_epitope_maps_1mpi_PrM_figure <-
  ggplot() +
  geom_bar(data= IgG_epitope_maps_1mpi_PrM, aes(x= Amino_Acid_Position, y= Percent_Positive_Animals, color= Virologic_Control_Group, fill= Virologic_Control_Group), stat= 'identity') +
  theme_classic() +
  scale_x_continuous(name= 'Amino Acid Position', expand= c(0,0), limits= c(120, 220), breaks= c(130, 150, 170, 190, 210)) +
  scale_y_continuous(name= "Positive Dams (%)", expand= c(0,0), limits= c(0,100), breaks= c(0, 25, 50, 75, 100)) +
  labs(title= '1 MPI (IgG)') +
...
IgG_epitope_maps_1mpi_mem_figure <-
  ggplot() +
  geom_bar(data= IgG_epitope_maps_1mpi_mem, aes(x= Amino_Acid_Position, y= Percent_Positive_Animals, color= Virologic_Control_Group, fill= Virologic_Control_Group), stat= 'identity') +
  theme_classic() +
  scale_x_continuous(name= 'Amino Acid Position', expand= c(0,0), limits= c(210, 300), breaks= c(220, 240, 260, 280, 300)) +
  scale_y_continuous(name= "Positive Dams (%)", expand= c(0,0), limits= c(0,100), breaks= c(0, 25, 50, 75, 100)) +
  labs(title= '1 MPI (IgG)') +
...
IgG_epitope_maps_1mpi_env_figure <-
  ggplot() +
  geom_bar(data= IgG_epitope_maps_1mpi_env, aes(x= Amino_Acid_Position, y= Percent_Positive_Animals, color= Virologic_Control_Group, fill= Virologic_Control_Group), stat= 'identity') +
  theme_classic() +
  scale_x_continuous(name= 'Amino Acid Position', expand= c(0,0), limits= c(280, 805), breaks= c(300, 400, 500, 600, 700, 800)) +
  scale_y_continuous(name= "Positive Dams (%)", expand= c(0,0), limits= c(0,100), breaks= c(0, 25, 50, 75, 100)) +
  labs(title= '1 MPI (IgG)') +
...
IgG_epitope_maps_1mpi_NS1_figure <-
  ggplot() +
  geom_bar(data= IgG_epitope_maps_1mpi_NS1, aes(x= Amino_Acid_Position, y= Percent_Positive_Animals, color= Virologic_Control_Group, fill= Virologic_Control_Group), stat= 'identity') +
  theme_classic() +
  scale_x_continuous(name= 'Amino Acid Position', expand= c(0,0), limits= c(785, 1165), breaks= c(800, 900, 1000, 1100)) +
  scale_y_continuous(name= "Positive Dams (%)", expand= c(0,0), limits= c(0,100), breaks= c(0, 25, 50, 75, 100)) +
  labs(title= '1 MPI (IgG)') +
...
IgG_epitope_maps_1mpi_NS2A_figure <-
  ggplot() +
  geom_bar(data= IgG_epitope_maps_1mpi_NS2A, aes(x= Amino_Acid_Position, y= Percent_Positive_Animals, color= Virologic_Control_Group, fill= Virologic_Control_Group), stat= 'identity') +
  theme_classic() +
  scale_x_continuous(name= 'Amino Acid Position', expand= c(0,0), limits= c(1150, 1385), breaks= c(1200, 1250, 1300, 1350)) +
  scale_y_continuous(name= "Positive Dams (%)", expand= c(0,0), limits= c(0,100), breaks= c(0, 25, 50, 75, 100)) +
  labs(title= '1 MPI (IgG)') +
...
IgG_epitope_maps_1mpi_NS2B_figure <-
  ggplot() +
  geom_bar(data= IgG_epitope_maps_1mpi_NS2B, aes(x= Amino_Acid_Position, y= Percent_Positive_Animals, color= Virologic_Control_Group, fill= Virologic_Control_Group), stat= 'identity') +
  theme_classic() +
  scale_x_continuous(name= 'Amino Acid Position', expand= c(0,0), limits= c(1370, 1530), breaks= c(1380, 1420, 1460, 1500)) +
  scale_y_continuous(name= "Positive Dams (%)", expand= c(0,0), limits= c(0,100), breaks= c(0, 25, 50, 75, 100)) +
  labs(title= '1 MPI (IgG)') +
...
IgG_epitope_maps_1mpi_NS3_figure <-
  ggplot() +
  geom_bar(data= IgG_epitope_maps_1mpi_NS3, aes(x= Amino_Acid_Position, y= Percent_Positive_Animals, color= Virologic_Control_Group, fill= Virologic_Control_Group), stat= 'identity') +
  theme_classic() +
  scale_x_continuous(name= 'Amino Acid Position', expand= c(0,0), limits= c(1500, 2150), breaks= c(1600, 1700, 1800, 1900, 2000, 2100)) +
  scale_y_continuous(name= "Positive Dams (%)", expand= c(0,0), limits= c(0,100), breaks= c(0, 25, 50, 75, 100)) +
  labs(title= '1 MPI (IgG)') +
...
IgG_epitope_maps_1mpi_NS4A_figure <-
  ggplot() +
  geom_bar(data= IgG_epitope_maps_1mpi_NS4A, aes(x= Amino_Acid_Position, y= Percent_Positive_Animals, color= Virologic_Control_Group, fill= Virologic_Control_Group), stat= 'identity') +
  theme_classic() +
  scale_x_continuous(name= 'Amino Acid Position', expand= c(0,0), limits= c(2115, 2280), breaks= c(2125, 2175, 2225, 2275)) +
  scale_y_continuous(name= "Positive Dams (%)", expand= c(0,0), limits= c(0,100), breaks= c(0, 25, 50, 75, 100)) +
  labs(title= '1 MPI (IgG)') +
...
IgG_epitope_maps_1mpi_NS4B_figure <-
  ggplot() +
  geom_bar(data= IgG_epitope_maps_1mpi_NS4B, aes(x= Amino_Acid_Position, y= Percent_Positive_Animals, color= Virologic_Control_Group, fill= Virologic_Control_Group), stat= 'identity') +
  theme_classic() +
  scale_x_continuous(name= 'Amino Acid Position', expand= c(0,0), limits= c(2265, 2550), breaks= c(2300, 2350, 2400, 2450, 2500)) +
  scale_y_continuous(name= "Positive Dams (%)", expand= c(0,0), limits= c(0,100), breaks= c(0, 25, 50, 75, 100)) +
  labs(title= '1 MPI (IgG)') +
...
IgG_epitope_maps_1mpi_NS5_figure <-
  ggplot() +
  geom_bar(data= IgG_epitope_maps_1mpi_NS5, aes(x= Amino_Acid_Position, y= Percent_Positive_Animals, color= Virologic_Control_Group, fill= Virologic_Control_Group), stat= 'identity') +
  theme_classic() +
  scale_x_continuous(name= 'Amino Acid Position', expand= c(0,0), limits= c(2515, 3415), breaks= c(2520, 2720, 2920, 3120, 3320)) +
  scale_y_continuous(name= "Positive Dams (%)", expand= c(0,0), limits= c(0,100), breaks= c(0, 25, 50, 75, 100)) +
  labs(title= '1 MPI (IgG)') +
...
IgG_epitope_maps_3.4mpi$Amino_Acid_Position = as.numeric(IgG_epitope_maps_3.4mpi$Amino_Acid_Position)
...
IgG_epitope_maps_3.4mpi_capsid_figure <-
  ggplot() +
  geom_bar(data= IgG_epitope_maps_3.4mpi_capsid, aes(x= Amino_Acid_Position, y= Percent_Positive_Animals, color= Virologic_Control_Group, fill= Virologic_Control_Group), stat= 'identity') +
  theme_classic() +
  scale_x_continuous(name= 'Amino Acid Position', expand= c(0,0), limits= c(0, 125), breaks= c(0, 30, 60, 90, 120)) +
  scale_y_continuous(name= "Positive Dams (%)", expand= c(0,0), limits= c(0,100), breaks= c(0, 25, 50, 75, 100)) +
...
IgG_epitope_maps_3.4mpi_PrM_figure <-
  ggplot() +
  geom_bar(data= IgG_epitope_maps_3.4mpi_PrM, aes(x= Amino_Acid_Position, y= Percent_Positive_Animals, color= Virologic_Control_Group, fill= Virologic_Control_Group), stat= 'identity') +
  theme_classic() +
  scale_x_continuous(name= 'Amino Acid Position', expand= c(0,0), limits= c(120, 220), breaks= c(130, 150, 170, 190, 210)) +
  scale_y_continuous(name= "Positive Dams (%)", expand= c(0,0), limits= c(0,100), breaks= c(0, 25, 50, 75, 100)) +
  labs(title= '3-4 MPI (IgG)') +
...
IgG_epitope_maps_3.4mpi_mem_figure <-
  ggplot() +
  geom_bar(data= IgG_epitope_maps_3.4mpi_mem, aes(x= Amino_Acid_Position, y= Percent_Positive_Animals, color= Virologic_Control_Group, fill= Virologic_Control_Group), stat= 'identity') +
  theme_classic() +
  scale_x_continuous(name= 'Amino Acid Position', expand= c(0,0), limits= c(210, 300), breaks= c(220, 240, 260, 280, 300)) +
  scale_y_continuous(name= "Positive Dams (%)", expand= c(0,0), limits= c(0,100), breaks= c(0, 25, 50, 75, 100)) +
  labs(title= '3-4 MPI (IgG)') +
...
IgG_epitope_maps_3.4mpi_env_figure <-
  ggplot() +
  geom_bar(data= IgG_epitope_maps_3.4mpi_env, aes(x= Amino_Acid_Position, y= Percent_Positive_Animals, color= Virologic_Control_Group, fill= Virologic_Control_Group), stat= 'identity') +
  theme_classic() +
  scale_x_continuous(name= 'Amino Acid Position', expand= c(0,0), limits= c(280, 805), breaks= c(300, 400, 500, 600, 700, 800)) +
  scale_y_continuous(name= "Positive Dams (%)", expand= c(0,0), limits= c(0,100), breaks= c(0, 25, 50, 75, 100)) +
  labs(title= '3-4 (MPI)') +
...
IgG_epitope_maps_3.4mpi_NS1_figure <-
  ggplot() +
  geom_bar(data= IgG_epitope_maps_3.4mpi_NS1, aes(x= Amino_Acid_Position, y= Percent_Positive_Animals, color= Virologic_Control_Group, fill= Virologic_Control_Group), stat= 'identity') +
  theme_classic() +
  scale_x_continuous(name= 'Amino Acid Position', expand= c(0,0), limits= c(785, 1165), breaks= c(800, 900, 1000, 1100)) +
  scale_y_continuous(name= "Positive Dams (%)", expand= c(0,0), limits= c(0,100), breaks= c(0, 25, 50, 75, 100)) +
  labs(title= '3-4 MPI (IgG)') +
...
IgG_epitope_maps_3.4mpi_NS2A_figure <-
  ggplot() +
  geom_bar(data= IgG_epitope_maps_3.4mpi_NS2A, aes(x= Amino_Acid_Position, y= Percent_Positive_Animals, color= Virologic_Control_Group, fill= Virologic_Control_Group), stat= 'identity') +
  theme_classic() +
  scale_x_continuous(name= 'Amino Acid Position', expand= c(0,0), limits= c(1150, 1385), breaks= c(1200, 1250, 1300, 1350)) +
  scale_y_continuous(name= "Positive Dams (%)", expand= c(0,0), limits= c(0,100), breaks= c(0, 25, 50, 75, 100)) +
  labs(title= '3-4 MPI (IgG)') +
...
IgG_epitope_maps_3.4mpi_NS2B_figure <-
  ggplot() +
  geom_bar(data= IgG_epitope_maps_3.4mpi_NS2B, aes(x= Amino_Acid_Position, y= Percent_Positive_Animals, color= Virologic_Control_Group, fill= Virologic_Control_Group), stat= 'identity') +
  theme_classic() +
  scale_x_continuous(name= 'Amino Acid Position', expand= c(0,0), limits= c(1370, 1530), breaks= c(1380, 1420, 1460, 1500)) +
  scale_y_continuous(name= "Positive Dams (%)", expand= c(0,0), limits= c(0,100), breaks= c(0, 25, 50, 75, 100)) +
  labs(title= '3-4 MPI (IgG)') +
...
IgG_epitope_maps_3.4mpi_NS3_figure <-
  ggplot() +
  geom_bar(data= IgG_epitope_maps_3.4mpi_NS3, aes(x= Amino_Acid_Position, y= Percent_Positive_Animals, color= Virologic_Control_Group, fill= Virologic_Control_Group), stat= 'identity') +
  theme_classic() +
  scale_x_continuous(name= 'Amino Acid Position', expand= c(0,0), limits= c(1500, 2150), breaks= c(1600, 1700, 1800, 1900, 2000, 2100)) +
  scale_y_continuous(name= "Positive Dams (%)", expand= c(0,0), limits= c(0,100), breaks= c(0, 25, 50, 75, 100)) +
  labs(title= '3-4 MPI (IgG)') +
...
IgG_epitope_maps_3.4mpi_NS4A_figure <-
  ggplot() +
  geom_bar(data= IgG_epitope_maps_3.4mpi_NS4A, aes(x= Amino_Acid_Position, y= Percent_Positive_Animals, color= Virologic_Control_Group, fill= Virologic_Control_Group), stat= 'identity') +
  theme_classic() +
  scale_x_continuous(name= 'Amino Acid Position', expand= c(0,0), limits= c(2115, 2280), breaks= c(2125, 2175, 2225, 2275)) +
  scale_y_continuous(name= "Positive Dams (%)", expand= c(0,0), limits= c(0,100), breaks= c(0, 25, 50, 75, 100)) +
  labs(title= '3-4 MPI (IgG)') +
...
IgG_epitope_maps_3.4mpi_NS4B_figure <-
  ggplot() +
  geom_bar(data= IgG_epitope_maps_3.4mpi_NS4B, aes(x= Amino_Acid_Position, y= Percent_Positive_Animals, color= Virologic_Control_Group, fill= Virologic_Control_Group), stat= 'identity') +
  theme_classic() +
  scale_x_continuous(name= 'Amino Acid Position', expand= c(0,0), limits= c(2265, 2550), breaks= c(2300, 2350, 2400, 2450, 2500)) +
  scale_y_continuous(name= "Positive Dams (%)", expand= c(0,0), limits= c(0,100), breaks= c(0, 25, 50, 75, 100)) +
  labs(title= '3-4 MPI (IgG)') +
...
IgG_epitope_maps_3.4mpi_NS5_figure <-
  ggplot() +
  geom_bar(data= IgG_epitope_maps_3.4mpi_NS5, aes(x= Amino_Acid_Position, y= Percent_Positive_Animals, color= Virologic_Control_Group, fill= Virologic_Control_Group), stat= 'identity') +
  theme_classic() +
  scale_x_continuous(name= 'Amino Acid Position', expand= c(0,0), limits= c(2515, 3415), breaks= c(2520, 2720, 2920, 3120, 3320)) +
  scale_y_continuous(name= "Positive Dams (%)", expand= c(0,0), limits= c(0,100), breaks= c(0, 25, 50, 75, 100)) +
  labs(title= '3-4 MPI (IgG)') +
